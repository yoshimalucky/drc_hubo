...
void DRCPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
    ...
    // Create Socket ---------------------
    FILE *fpNet = NULL;
    fpNet = fopen("/home/y-tanaka/ros/indigo/src/drc_hubo/ros/settings/network.txt", "r");
    if(fpNet == NULL){
    ...
    FILE *fpGain = NULL;
    fpGain = fopen("/home/y-tanaka/ros/indigo/src/drc_hubo/ros/settings/gain.txt", "r");
    if(fpGain == NULL){
